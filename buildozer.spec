...
# (str) Package name
package.name = chemistrypro

# (str) Package domain (needed for android/ios packaging)
package.domain = com.chemistrypro
...
presplash.filename = %(source.dir)s/templates/static/splash.png

# (str) Icon of the application
icon.filename = %(source.dir)s/templates/static/icon.jpg
...
# OUYA-ODK/libs/*.jar
android.add_jars = new_venv/lib/python3.12/site-packages/webview/lib/pywebview-android.jar
